# 📋 TIS Leave Management - คู่มือการติดตั้ง

คู่มือการติดตั้งระบบจัดการการลาของพนักงานอย่างละเอียด

## 🎯 ภาพรวมการติดตั้ง

เอกสารนี้จะแนะนำการติดตั้ง TIS Leave Management ตั้งแต่เริ่มต้นจนพร้อมใช้งาน
...
NEXT_PUBLIC_APP_NAME="TIS Leave Management"
```
...
**🎉 ติดตั้งสำเร็จ!** ระบบ TIS Leave Management พร้อมใช้งานแล้ว
